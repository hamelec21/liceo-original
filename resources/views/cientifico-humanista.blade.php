<html lang="es">
  <head>
    <title>Cientifico Humanista</title>
    <meta charset="utf-8">
		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-9 ftco-animate text-center">
					<h1 class="mb-2 t1 ">Cientifico Humanista</h1>
					<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Cientifico Humanista<i class="ion-ios-arrow-forward"></i></span></p>
				</div>
			</div>
		</div>
...
@endforeach
  ...
  <br>
  <!--Inicio de Seccion de Fotos-->
  <section class="ftco-gallery">
    <div class="container-wrap">
      <div class="row no-gutters">
        @foreach ($foto as $fotos)
        <div class="col-md-3 ftco-animate">
          <a href="{{asset($fotos->foto)}}" class="gallery image-popup img d-flex align-items-center" style="background-image: url({{asset($fotos->foto)}});">
