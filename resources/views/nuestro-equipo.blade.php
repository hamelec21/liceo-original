		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-9 ftco-animate text-center">
					<h1 class="mb-2 t1 ">Nuestro Equipo Impulsor </h1>
					<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Nuestro Equipo Impulsor<i class="ion-ios-arrow-forward"></i></span></p>
				</div>
			</div>
		</div>
                    ...
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch"
                                style="background-image: url({{ $teams->foto }});"></div>
                        </div>
                        <div class="text pt-3 text-center">
                            <h3>{{ $teams->nombre }}</h3>
                            <span class="position mb-2"><b>{{ $teams->cargo }}</b></span>
                        </div>
                    </div>
                </div>
            @endforeach
